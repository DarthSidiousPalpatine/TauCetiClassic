...
/datum/component/footstep/proc/prepare_step()
	...
	if(!T.footstep || LM.mount || LM.lying || LM.throwing || LM.crawling || LM.is_ventcrawling)
		if (LM.lying && !LM.mount && LM.crawling && !(!T.footstep || LM.is_ventcrawling)) //play crawling sound if we're lying

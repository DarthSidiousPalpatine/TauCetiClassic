...
/obj/item/weapon/storage/box/lunchboxntempty
	name = "Nanotrasen Lunchbox"
	desc = "It's a lunchbox, issued to some employers of NanoTrasen, contains some food."
	icon_state = "ntlunchbox"
...
/obj/item/weapon/storage/box/lunchboxnt/atom_init()
	. = ..()
	new /obj/item/weapon/reagent_containers/food/snacks/meatballsoup(src)
	...
	new /obj/item/weapon/reagent_containers/food/snacks/twobread(src)
	new /obj/item/weapon/reagent_containers/food/snacks/muffin(src)
	new /obj/item/weapon/reagent_containers/food/drinks/drinkingglass/kvass(src)
	new /obj/item/weapon/kitchen/utensil/fork(src)
	new /obj/item/weapon/kitchenknife/plastic(src)

/obj/item/weapon/storage/box/lunchboxlbempty
	name = "LB company Lunchbox"
	desc = "It's a lunchbox of LB food delivery company, contains some hot food and fish."
	icon_state = "lblunchbox"
...
/obj/item/weapon/storage/box/lunchboxlb/atom_init()
	. = ..()
	new /obj/item/weapon/reagent_containers/food/snacks/chinese/sweetsourchickenball(src)
	new /obj/item/weapon/reagent_containers/food/snacks/chinese/rice(src)
	new /obj/item/weapon/reagent_containers/food/snacks/chinese/tao(src)
	new /obj/item/weapon/reagent_containers/food/snacks/chinese/newdles(src)
	new /obj/item/weapon/reagent_containers/food/snacks/chinese/chowmein(src)
	new /obj/item/weapon/reagent_containers/food/drinks/drinkingglass/nuka_cola(src)
	new /obj/item/weapon/kitchen/utensil/fork/sticks(src)
	new /obj/item/weapon/kitchen/utensil/fork/sticks(src)

/obj/item/weapon/storage/box/lunchboxvipempty
	name = "Central Command Lunchbox"
	desc = "It's a lunchbox, issued to CentCom employers of NanoTrasen, contains some luxury food."
	icon_state = "viplunchbox"

/obj/item/weapon/storage/box/lunchboxvip
	name = "Central Command Lunchbox"
	desc = "It's a lunchbox, issued to CentCom employers of NanoTrasen, contains some luxury food."
	icon_state = "viplunchbox"

/obj/item/weapon/storage/box/lunchboxvip/atom_init()
	. = ..()
	new /obj/item/weapon/reagent_containers/food/snacks/sliceable/turkey(src)
	new /obj/item/weapon/reagent_containers/food/snacks/herbsalad(src)
	new /obj/item/weapon/reagent_containers/food/condiment/hotsauce(src)
...
/obj/item/weapon/storage/box/preflunchboxempty
	name = "Home Lunchbox"
	desc = "It's a lunchbox, you took from your home, contains some home food."
	icon_state = "preflunchbox"

/obj/item/weapon/storage/box/preflunchbox
	name = "Home Lunchbox"
	desc = "It's a lunchbox, you took from your home, contains some home food."
	icon_state = "preflunchbox"

/obj/item/weapon/storage/box/preflunchbox/atom_init()
	. = ..()
	new /obj/item/weapon/reagent_containers/food/snacks/toastedsandwich(src)
	new /obj/item/weapon/reagent_containers/food/snacks/sugarcookie(src)
	new /obj/item/weapon/reagent_containers/food/snacks/sugarcookie(src)
...
/obj/item/weapon/storage/box/paperpack
	name = "Paper pack"

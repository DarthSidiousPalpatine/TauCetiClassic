/obj/item/robot_parts/attack(mob/living/carbon/human/M, mob/living/carbon/user, def_zone)
	...
	if(!((locate(/obj/machinery/optable, M.loc) && M.resting) || (locate(/obj/structure/stool/bed/roller, M.loc) && (M.mount || M.lying || M.weakened || M.stunned || M.paralysis || M.stat)) && prob(75) || (locate(/obj/structure/table, M.loc) && (M.lying || M.weakened || M.stunned || M.paralysis || M.stat) && prob(66))))
		return ..()

...
/mob/living/proc/MobBump(mob/M)
	...
	if((M.a_intent == INTENT_HELP || M.restrained()) && (a_intent == INTENT_HELP || restrained()) && M.canmove && canmove && !M.mount && !M.mount_mob) // mutual brohugs all around!
		var/can_switch = TRUE
